...
DIFFICULTY_GUIDE = {
    ...
    "상": (
        ...
        "끝나는 단어를 전략적으로 골라야 해. "
        "특히 다음과 같은, 다음 사람이 이어가기 극히 어려운 음절로 끝나는 단어를 최우선으로 노려: "
        "'늄'(예: 알루미늄), '츠'(예: 스포츠), '흠'(예: 아이스크림 계열 외래어), "
        "'붸/봬/뷁' 등 겹모음+겹받침 조합, 'ㄶ/ㄺ/ㄼ/ㅄ' 같은 겹받침으로 끝나는 단어, "
        "'ㅑ/ㅕ/ㅘ/ㅚ/ㅟ/ㅢ' 같은 흔치 않은 모음으로 끝나는 단어, 외래어나 전문용어의 마지막 음절. "
